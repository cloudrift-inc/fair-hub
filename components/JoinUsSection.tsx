...
const JoinUsSection: React.FC = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black px-4 text-center">
      <div className="">
        <h2 className="text-6xl font-extrabold text-white">Join Us</h2>
        <p className="mt-10 max-w-7xl text-lg font-light text-[#717177]">
          ...
          Neuralrack, we don’t just see ourselves as your service provider but
        ...
        <p className="mt-20 max-w-7xl text-lg font-bold text-[#B2B2B2]">
          Experience the Neuralrack Difference
        </p>
        <p className="mt-4 max-w-7xl text-lg font-light text-[#717177]">
